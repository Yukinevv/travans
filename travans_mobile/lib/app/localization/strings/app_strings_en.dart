const Map<String, String> appStringsEn = {
  ...
  'accountSectionProfile': 'Profile details',
  ...
  'accountHeaderKicker': 'Account',
  'accountHeaderTitle': 'User settings',
  'accountHeaderSubtitle':
      'Update your account details, avatar, and password without leaving the app.',
  'accountProfileDescription':
      'These details are used in your session and across the application.',
  'accountProfileAvatarHint': 'JPG, PNG, WEBP, or GIF up to 5 MB.',
  'accountProfileAvatarUploading': 'Uploading avatar...',
  'accountProfileSave': 'Save profile',
  'accountProfileSaved': 'Your account details have been saved.',
  'accountProfilePickAvatar': 'Change avatar',
  'accountSecurityDescription':
      'After changing the password, your session will be refreshed automatically.',
  'accountSecurityGoogleManaged':
      'This account uses Google sign-in, so the password is managed by Google.',
  'accountSecurityCurrentPassword': 'Current password',
  'accountSecurityNewPassword': 'New password',
  'accountSecurityRepeatPassword': 'Repeat new password',
  'accountSecurityChangePassword': 'Change password',
  'accountSecurityPasswordChanged': 'Your password has been changed.',
  'accountSecurityPasswordMismatch': 'The new passwords must match.',
  'accountLoading': 'Loading account data...',
  'accountAvatarInvalid': 'Choose a JPG, PNG, WEBP, or GIF file up to 5 MB.',
  ...
  'errorAccountProfileLoad': 'Failed to load account details.',
  'errorAccountProfileUpdate': 'Failed to save account details.',
  'errorAccountPasswordChange': 'Failed to change the password.',
  'errorAccountAvatarUpload': 'Failed to upload the avatar.',
